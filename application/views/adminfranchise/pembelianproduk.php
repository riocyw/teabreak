        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <div class="row">
                    <h3 align="right" style="width: -webkit-fill-available;margin-right: 2vh;margin-bottom: 4vh;" id="total_pembelian">Total Pembelian : RP. 100.000</h3>
                </div>
            </div>
        </div>
    </div><!-- /#right-panel -->
